...
namespace ProjectScare.ServiceLocator
{
    ...
    {
        [ShowInInspector] private List<CurrentConnectedPlayerStats> _currentConnectedPlayerStats;
        ...
        public void StartOrStopServer()
        {
            ...
            Debug.Log($"Server Status: <color=blue>{_serverState.ToString()}</color>");
        }
        ...
        public void StartOrStopClient()
        {
            ...
            Debug.Log($"Server Status: <color=blue>{_clientState.ToString()}</color>");
        }
        ...
        void OnClientStarted(ClientConnectionStateArgs args)
        {
            ...
            {
                StartCoroutine(LoadMainScene(SceneManager.SceneType.CabinScene));
            }
        }
    ...
    public class CurrentConnectedPlayerStats
    {
        ...
        [ShowInInspector] private NetworkConnection _playerNetworkConnection;
